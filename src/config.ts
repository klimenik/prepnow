// Default location of the hosted question bank (GitHub Pages of the content repo).
// Users can override this at runtime via the Settings panel; the override is stored
